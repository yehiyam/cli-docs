...
const { argv } = yargs.options('path', {
    ...
    alias: ['o'],
    default: './Readme.md'
}).options('installTemplate', {
    describe: 'replaces the default how to install.',
    type: 'string',
}).usage('$0', 'Tool for creating markdown Readme documentation for cli tools created with [yargs](https://github.com/yargs/yargs)');
